...
$event\ A:\ 75+\ ys\ woman\ has\ a\ positive\ scan\ finding$  
$event\ B:\ 75+\ ys\ woman\ has\ dementia$  
...
$p(B|A) = \frac{p(A|B)\times p(B)}{p(A|B)\times p(B) + p(A|B^\complement)\times p(B^\complement)} = \frac{0.8\times 0.05}{0.8\times 0.05+0.1\times 0.95} = 0.296$  
