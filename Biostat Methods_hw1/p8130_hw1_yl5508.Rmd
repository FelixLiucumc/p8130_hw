...
**(b)** We can see characteristics of underlying distribution: right-skewed,  unimodal distribution.
...
**(b)** For car crash DepScore, the characteristic of its distribution is right-skewed and Unimodal.  
